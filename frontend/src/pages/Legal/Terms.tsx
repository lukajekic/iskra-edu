...
## 8. IskraAI
IskraAI je rešenje namenjeno učenicima u poboljšanju razumevanja ključnih koncepta prilikom izrade zadataka.

IskraAI se može aktivirati jednom po zadatku, ukoliko je odgovor netačan i ukoliko profesor ostavi opciju uključenom.

U svakom trenutku profesor može zabraniti upotrebu IskraAI.

IskraAI namenjena je kao veštačka inteligencija koja podstiče učenike na razmišljanje umesto davanja tačnih odgovora.

IskraAI može pogrešiti i samim time Iskra ne odgovara za netačne, uvredljive ili bilo kakve odgovore koji narušavaju etiku platforme i obrazovnog procesa.

IskraAI prikuplja određene podatke, detalji obrade podataka od strane IskraAI dostupni su u odeljku "Politika privatnosti".
