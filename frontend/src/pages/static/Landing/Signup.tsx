...
const Signup = () => {
  return (
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-start py-12 px-6 md:p-20 box-border">
        ...
        <a target='_blank' href='https://forms.gle/a9kKbTemVmbyJSii8' className='w-full h-auto lg:h-full aspect-square lg:aspect-auto min-h-[300px]' id="contactbtn">
            <div className="transition-colors w-full h-full border-2 border-primary rounded-3xl lg:rounded-4xl flex flex-col p-6 md:p-10 justify-between text-primary hover:bg-primary hover:text-white box-border">
